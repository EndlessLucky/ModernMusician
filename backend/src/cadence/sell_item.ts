...
import ModernMusician, ModernMusicianStorefront from 0xModernMusician

transaction(receiver: Address, saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    prepare(acct: AuthAccount) {
        ...
        let modernMusicianCollectionProviderPrivatePath = /private/modernMusicianCollectionProviderForNFTStorefront

        let recipientAcc = getAccount(receiver)
        self.flowReceiver = recipientAcc.getCapability<&FUSD.Vault{FungibleToken.Receiver}>(/public/fusdReceiver)!
