...
import ModernMusician from "./ModernMusician.cdc"
...
pub contract ModernMusicianStorefront {
    ...
    pub resource Listing: ListingPublic {
        ...
        pub fun purchase(payment: @FungibleToken.Vault): @NonFungibleToken.NFT {
            ...
            let nftLibrary : &ModernMusician.NFT = ref as! &ModernMusician.NFT
            if ModernMusicianStorefront.numberPurchasedByType[nftLibrary.type] == nil {
                ModernMusicianStorefront.numberPurchasedByType[nftLibrary.type] = 0
            }

            ModernMusicianStorefront.numberPurchasedByType[nftLibrary.type] = ModernMusicianStorefront.numberPurchasedByType[nftLibrary.type]! + 1
    ...
    pub resource Storefront : StorefrontManager, StorefrontPublic {
        ...
        //
         pub fun createListing(
            ...
            ModernMusicianStorefront.nftIDbyListing[nftID] = listing.uuid
        ...
        pub fun fetchListing(nftID: UInt64): &Listing{ListingPublic}? {
           ...
           let listingResourceID = ModernMusicianStorefront.nftIDbyListing[nftID]
    ...
    pub fun getNumberPurchasedByType(type: UInt64): UInt64?{
        return ModernMusicianStorefront.numberPurchasedByType[type];
    }

    init () {
        self.StorefrontStoragePath = /storage/ModernMusicianStorefront
        self.StorefrontPublicPath = /public/ModernMusicianStorefront

        self.nftIDbyListing = {}
        self.numberPurchasedByType = {}

        self.account.save(<-ModernMusicianStorefront.createStorefront() , to: self.StorefrontStoragePath) 
        self.account.link<&ModernMusicianStorefront.Storefront{ModernMusicianStorefront.StorefrontPublic}>(self.StorefrontPublicPath, target: self.StorefrontStoragePath)
        ...
        emit ModernMusicianStorefrontInitialized()
    }
}